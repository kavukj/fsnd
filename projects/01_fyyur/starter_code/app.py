...
def search_venues():
  ...
  try:
    ...
    search_data = Venue.query.filter(Venue.name.ilike('%{}%'.format(searchTerm))).all()
    data=[]
...
def create_venue_submission():
  ...
  try:
    ...
    description=seeking_description,seeking_talent=seeking_talent,genres=genres)
...
def search_artists():
  ...
  try:
    searchTerm = request.form.get('search_term')
    search_data = Artist.query.filter(Artist.name.ilike('%{}%'.format(searchTerm))).all()
    data=[]
...
def create_artist_submission():
  ...
  try:
    ...
    facebook_link=facebook_link,image_link=image_link,website_link=website_link,
    description=seeking_description,seeking_venue=seeking_venue,genres=genres)
